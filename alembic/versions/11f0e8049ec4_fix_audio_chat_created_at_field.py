...
Revision ID: 11f0e8049ec4
Revises: 8686903bc931
Create Date: 2025-07-25 00:33:29.695627
...
revision: str = '11f0e8049ec4'
down_revision: Union[str, None] = '8686903bc931'
...
def upgrade() -> None:
    ...
    op.add_column('structured_notes', sa.Column('user_question', sa.Text(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('structured_notes', sa.Column('chat_type', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.drop_column('structured_notes', 'user_question')
