...
Revision ID: 25e497f63230
Revises: 44d3c12912b2
Create Date: 2025-07-22 22:31:16.058390
...
revision: str = '25e497f63230'
down_revision: Union[str, None] = '44d3c12912b2'
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('document', sa.Column('user_id', sa.VARCHAR(), autoincrement=False, nullable=False))
