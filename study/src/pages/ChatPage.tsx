...
const IntroView: React.FC<IntroViewProps> = ({ inputValue, setInputValue, onSubmit, onVideo, onDocument, onBookChat }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full gap-8">
      ...
      <div className="flex gap-6">
        <button onClick={onVideo} className="flex flex-col items-center justify-center gap-3 bg-gray-200 dark:bg-slate-800 hover:bg-gray-300 dark:hover:bg-slate-700 w-32 h-32 rounded-lg transition-colors">
